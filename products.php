            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm rounded-3">
                        ...
                        <img src="./img/<?= $row["image"] ?>" class="card-img-top product-img rounded-top-3" alt="<?= $row["name"] ?>">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between p-3">
                            ...
                            <a href="product_detail.php?id=<?= $row["id"] ?>" class="btn btn-outline-dark w-100 fw-bold mt-2">
                                Xem Chi Tiết
                            </a>
                        </div>
