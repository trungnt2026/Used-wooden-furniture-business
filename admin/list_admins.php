        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 text-center">
                <div class="card coming-soon-card p-5">
                    ...
                    <h1 class="fw-bold text-dark mb-3">QUẢN LÝ ADMIN <br> ĐANG CẬP NHẬT</h1>
                    ...
                    <div>
                        <a href="dashboard.php" class="btn btn-primary px-4 py-2 rounded-pill fw-semibold shadow-sm">
